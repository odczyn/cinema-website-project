    ...
    <body>
        ...
        <div id="container">
            ...
            <script>
                            ...
                            ?>
                                ...
                                <div id='info'>
                                    ...
                                    <div class='movie-footer'>
                                        <span class='genre'><?php echo $row['genre']." | ".$row['length']." min." ?></span>
                                        <a href='harmonogram.php?movie=<?php echo $row['id'] ?>'><button>Zobacz 👀</button></a>
                                    </div>
                                </div>
                                `);
                            <?php
                ...
                ?>
                document.getElementById("slide1").innerHTML = slides[0];
                document.getElementById("slide2").innerHTML = slides[1];
            </script>
        </div>
        <div id="footer">
